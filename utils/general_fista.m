function [X, iter, min_cost] = general_fista(grad, Xinit, L, opts, calc_F)   
...
% -------------------------------------
    ...
    while  iter < opts.max_iter
        ...
        %     x_new = shrinkage(y_old - Linv*feval(grad, y_old), opts_projection);
        % else if strcmp(opts.regul, 'l1l2')
        %     x_new = projection_l1l2(y_old - Linv*feval(grad, y_old), opts_projection);
        % end 
        x_new = myprojection(y_old - Linv*feval(grad, y_old), opts_projection);
